...
export const FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    a: 'Строгостью правил и дозволенными рамками отыгрыша. Например, на No Rules вам не требуется знать лор или соблюдать кучу правил, когда на Hard RP все наооборот.',
  },
  {
  ...
  },
  {
    ...
    a: 'В каналах Discord-серверов #описание_*сервер* (SL), либо в игровом описании сервера.',
  },
]
